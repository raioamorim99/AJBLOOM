...
<div class="user-actions">
    <?php if (isset($_SESSION["usuario_id"])): ?>
      <span class="user-link">
        <i class="fas fa-user"></i> Olá, <?php echo htmlspecialchars($_SESSION["usuario_nome"]); ?>
      </span>
 ...
 <div class="slides">  
  ...
  <div class="slide">
    <picture>
      ...
      <img src="../assets/imagens/parallax.png" alt="Bem-vinda à AJBLOOM" />
    </picture>
...
<section class="ajb-newsletter animate-on-scroll">
  <h3>Fique por dentro das novidades!</h3>
  <p>Receba nossas coleções e promoções por e-mail.</p>
  <form id="ajb-newsletter-form">
...
<footer class="footer animate-on-scroll">
  <div class="footer-container">
    ...
    <div class="footer-column">
      ...
      <div class="social-icons">
        <a href="https://www.instagram.com/ajbloom_/"><img src="https://img.icons8.com/ios-filled/30/ffffff/instagram-new.png" alt="Instagram" loading="lazy" /></a>
        <a href="#"><img src="https://img.icons8.com/ios-filled/30/ffffff/tiktok.png" alt="TikTok" loading="lazy" /></a>
      </div>
    </div>
  </div>
  <div class="footer-bottom animate-on-scroll">
    ...
    <div class="footer-links">
      <a href="politica.html">Política de Privacidade</a><span>|</span>
      <a href="trocas.html">Trocas e Devoluções</a><span>|</span>
