document.addEventListener("DOMContentLoaded", () => {
  ...
  // ✅ CORRIGIDO: Menu responsivo com logs
  ...
  function init() {
    ...
    console.log("📱 Header mobile CORRIGIDO:")
    console.log("- Logo maior à esquerda")
    console.log("- Barra de pesquisa no centro")
    console.log("- Menu hambúrguer à direita")
    console.log("- Layout flex otimizado")
    console.log("🎯 Menu hambúrguer funcionando com logs")
  }
